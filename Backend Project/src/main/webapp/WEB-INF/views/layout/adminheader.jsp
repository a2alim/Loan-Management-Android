			...
			<div class="mother-grid-inner">
				...
				<div class="header-main">
					<div class="header-left">
						<div class="logo-name">
							<a href="/adminhome">
								<h1><span class="fa fa-recycle mr-2"></span style="padding-left: 10px">Loan Management</h1> <!--<img id="logo" src="" alt="Logo"/>-->
							</a>
						</div>
						<!--search-box-->
								...
								<li class="dropdown profile_details_drop"><a href="#"
									...
									aria-expanded="false">
										<div class="profile_img">
											<span class="prfil-img"><img style="border-radius: 50%" src="/assets/images/a2alim.jpg"
												alt=""> </span>
											<div class="user-name">
												<p><c:out value="${pageContext.request.remoteUser}"></c:out></p>
